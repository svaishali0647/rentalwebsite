...
function Nav() {
    ...
    useEffect(()=>{
  if(input.trim() === ""){
    // agar input empty hai to search data clear kar do
    setNewListData(listingData)
    return;
  }
  handleSearch(input)
    ...
    return (
        ...
        <div className='fixed top-0 bg-[white] z-[20]'>
            <div className='w-[100vw] min-h-[80px]  border-b-[1px] border-[#dcdcdc] px-[20px] flex items-center justify-between md:px-[40px] '>
                <div><img src={logo3} alt="" className='w-[120px]' /></div>
                ...
                <div className='w-[35%] relative hidden md:block '>
                    ...
                    <button className='absolute p-[10px] rounded-[50px] bg-[#df2828] right-[3%] top-[5px]'><FiSearch className='w-[20px] h-[20px] text-[white]' /></button>
                </div>
...
<div className='w-[100vw] h-[85px] bg-white flex items-center justify-start cursor-pointer gap-[40px] overflow-auto md:justify-center px-[15px] '>
    <div className='flex items-center justify-center flex-col hover:border-b-[1px] border-[#a6a5a5] text-[11px]' onClick={()=>{handleCategory("trending"); setCate("")}}>
        <MdWhatshot className='w-[22px] h-[22px] text-black' />
        <h3 className="text-[10px] text-black">Trending</h3>
    </div>

    <div className={`flex items-center justify-center flex-col hover:border-b-[1px] border-[#a6a5a5] text-[11px] ${cate=="villa"?"border-b-[1px] border-[#a6a5a5]":""}`} onClick={()=>handleCategory("villa")}>
        <GiFamilyHouse className='w-[22px] h-[22px] text-black' />
        <h3 className="text-[10px] text-black">Villa</h3>
    </div>

    <div className={`flex items-center justify-center flex-col hover:border-b-[1px] border-[#a6a5a5] text-[11px] ${cate=="farmHouse"?"border-b-[1px] border-[#a6a5a5]":""}`} onClick={()=>handleCategory("farmHouse")}>
        <FaTreeCity className='w-[22px] h-[22px] text-black' />
        <h3 className="text-[10px] text-black">Farm House</h3>
    </div>

    <div className={`flex items-center justify-center flex-col hover:border-b-[1px] border-[#a6a5a5] text-[11px] ${cate=="poolHouse"?"border-b-[1px] border-[#a6a5a5]":""}`} onClick={()=>handleCategory("poolHouse")}>
        <MdOutlinePool className='w-[22px] h-[22px] text-black' />
        <h3 className="text-[10px] text-black">Pool House</h3>
    </div>

    <div className={`flex items-center justify-center flex-col hover:border-b-[1px] border-[#a6a5a5] text-[11px] ${cate=="rooms"?"border-b-[1px] border-[#a6a5a5]":""}`} onClick={()=>handleCategory("rooms")}>
        <MdBedroomParent className='w-[22px] h-[22px] text-black' />
        <h3 className="text-[10px] text-black">Rooms</h3>
    </div>

    <div className={`flex items-center justify-center flex-col hover:border-b-[1px] border-[#a6a5a5] text-[11px] ${cate=="flat"?"border-b-[1px] border-[#a6a5a5]":""}`} onClick={()=>handleCategory("flat")}>
        <BiBuildingHouse className='w-[22px] h-[22px] text-black' />
        <h3 className="text-[10px] text-black">Flat</h3>
    </div>

    <div className={`flex items-center justify-center flex-col hover:border-b-[1px] border-[#a6a5a5] text-[11px] ${cate=="pg"?"border-b-[1px] border-[#a6a5a5]":""}`} onClick={()=>handleCategory("pg")}>
        <IoBedOutline className='w-[22px] h-[22px] text-black' />
        <h3 className="text-[10px] text-black">PG</h3>
    </div>

    <div className={`flex items-center justify-center flex-col hover:border-b-[1px] border-[#a6a5a5] text-[11px] ${cate=="cabin"?"border-b-[1px] border-[#a6a5a5]":""}`} onClick={()=>handleCategory("cabin")}>
        <GiWoodCabin className='w-[22px] h-[22px] text-black' />
        <h3 className="text-[10px] text-black">Cabins</h3>
    </div>

    <div className={`flex items-center justify-center flex-col hover:border-b-[1px] border-[#a6a5a5] text-[11px] ${cate=="shops"?"border-b-[1px] border-[#a6a5a5]":""}`} onClick={()=>handleCategory("shops")}>
        <SiHomeassistantcommunitystore className='w-[22px] h-[22px] text-black' />
        <h3 className="text-[10px] text-black">Shops</h3>
    </div>
</div>
